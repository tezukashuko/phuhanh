...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img class="" src="images/logo.png" class="img-fluid" alt="logo-header" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="brush.php">Industrial Brush</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="nav-engineering" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            engineering
                        </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="nav-cuttingtool" role="button" data-bs-toggle="dropdown" aria-expanded="false">
