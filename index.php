...
<div id="maincarousel" class="carousel carousel-dark slide" data-bs-ride="carousel" data-bs-ride="carousel" data-bs-interval="3000">
    ...
    <div class="box d-flex flex-wrap container-md">
        <div class="col-12 col-md-6 col-lg-4 my-2 rounded-2">
            <div class="card text-dark h-100 m-2 p-1">
                ...
                <div class="card-body m-0">
                    <h3 class="card-title">Air Compressor</h3>
                    <p class="card-text">
        ...
        <div class="col-12 col-md-6 col-lg-4 my-2 rounded-2">
            <div class="card text-dark h-100 m-2 p-1">
                ...
                <div class="card-body m-0">
                    <h3 class="card-title">Industrial Brush</h3>
                    <p class="card-text">
                        This is a wider card with supporting text below as a natural
                        lead-in to additional content. This content is a little bit
                        longer.
        ...
        <div class="col-12 col-md-6 col-lg-4 my-2 rounded-2">
            <div class="card text-dark h-100 m-2 p-1">
                ...
                <div class="card-body m-0">
                    <h3 class="card-title">Cutting Tools</h3>
                    <p class="card-text">
                        This is a wider card with supporting text below as a natural
                        lead-in to additional content. This content is a little bit
                        longer.
